# Module 15: Remotes, PRs & submodules (concepts)

**Kind:** `lab` · Primary lab: `remotes` · **Shipped**

[← Blame & bisect](../module14-blame-bisect/README.md) · [Course README](../README.md) · [Remote-tracking branches →](../module16-remote-tracking/README.md)

## Outcomes

After this module you can explain and practice the ideas taught by **`remotes`**, in the browser and/or with real Git.
...
1. Local: [http://127.0.0.1:8080/tools/remotes/index.html](http://127.0.0.1:8080/tools/remotes/index.html)
2. Live: [https://universal-verification-methodology.github.io/learning/tools/remotes/](https://universal-verification-methodology.github.io/learning/tools/remotes/)
