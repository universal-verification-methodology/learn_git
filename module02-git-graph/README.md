...
**Kind:** `lab` · Primary lab: `git-graph` · **Shipped**

[← Git mental model](../module01-git-mental-model/README.md) · [Course README](../README.md) · [.gitignore patterns →](../module03-gitignore-lab/README.md)

## Outcomes

After this module you can explain and practice the ideas taught by **`git-graph`**, in the browser and/or with real Git.
...
1. Local: [http://127.0.0.1:8080/tools/git-graph/index.html](http://127.0.0.1:8080/tools/git-graph/index.html)
2. Live: [https://universal-verification-methodology.github.io/learning/tools/git-graph/](https://universal-verification-methodology.github.io/learning/tools/git-graph/)
