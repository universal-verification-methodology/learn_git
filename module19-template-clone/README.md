...
**Kind:** `lab` · Primary lab: `template-clone` · **Shipped**

[← Submodule pitfalls](../module18-submodule-pitfalls/README.md) · [Course README](../README.md) · [Submission reproducibility →](../module20-submission-repro/README.md)

## Outcomes

After this module you can explain and practice the ideas taught by **`template-clone`**, in the browser and/or with real Git.
...
1. Local: [http://127.0.0.1:8080/tools/template-clone/index.html](http://127.0.0.1:8080/tools/template-clone/index.html)
2. Live: [https://universal-verification-methodology.github.io/learning/tools/template-clone/](https://universal-verification-methodology.github.io/learning/tools/template-clone/)
