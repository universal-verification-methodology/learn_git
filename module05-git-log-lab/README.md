...
**Kind:** `lab` · Primary lab: `git-log-lab` · **Shipped**

[← Commit messages](../module04-commit-message-lab/README.md) · [Course README](../README.md) · [Safe undo →](../module06-git-undo-safe/README.md)

## Outcomes

After this module you can explain and practice the ideas taught by **`git-log-lab`**, in the browser and/or with real Git.
...
1. Local: [http://127.0.0.1:8080/tools/git-log-lab/index.html](http://127.0.0.1:8080/tools/git-log-lab/index.html)
2. Live: [https://universal-verification-methodology.github.io/learning/tools/git-log-lab/](https://universal-verification-methodology.github.io/learning/tools/git-log-lab/)
