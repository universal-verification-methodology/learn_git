...
**Kind:** `lab` · Primary lab: `git-conflicts` · **Shipped**

[← Branch naming](../module09-branch-strategy/README.md) · [Course README](../README.md) · [Rebase vs merge →](../module11-git-rebase-merge/README.md)

## Outcomes

After this module you can explain and practice the ideas taught by **`git-conflicts`**, in the browser and/or with real Git.
...
1. Local: [http://127.0.0.1:8080/tools/git-conflicts/index.html](http://127.0.0.1:8080/tools/git-conflicts/index.html)
2. Live: [https://universal-verification-methodology.github.io/learning/tools/git-conflicts/](https://universal-verification-methodology.github.io/learning/tools/git-conflicts/)
