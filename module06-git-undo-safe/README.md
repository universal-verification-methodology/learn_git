...
**Kind:** `lab` · Primary lab: `git-undo-safe` · **Shipped**

[← git log options](../module05-git-log-lab/README.md) · [Course README](../README.md) · [Stash scenarios →](../module07-git-stash-lab/README.md)

## Outcomes

After this module you can explain and practice the ideas taught by **`git-undo-safe`**, in the browser and/or with real Git.
...
1. Local: [http://127.0.0.1:8080/tools/git-undo-safe/index.html](http://127.0.0.1:8080/tools/git-undo-safe/index.html)
2. Live: [https://universal-verification-methodology.github.io/learning/tools/git-undo-safe/](https://universal-verification-methodology.github.io/learning/tools/git-undo-safe/)
