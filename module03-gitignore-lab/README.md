...
**Kind:** `lab` · Primary lab: `gitignore-lab` · **Shipped**

[← Graph, stage, commit (playground)](../module02-git-graph/README.md) · [Course README](../README.md) · [Commit messages →](../module04-commit-message-lab/README.md)

## Outcomes

After this module you can explain and practice the ideas taught by **`gitignore-lab`**, in the browser and/or with real Git.
...
1. Local: [http://127.0.0.1:8080/tools/gitignore-lab/index.html](http://127.0.0.1:8080/tools/gitignore-lab/index.html)
2. Live: [https://universal-verification-methodology.github.io/learning/tools/gitignore-lab/](https://universal-verification-methodology.github.io/learning/tools/gitignore-lab/)
