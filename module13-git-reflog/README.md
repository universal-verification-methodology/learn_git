...
**Kind:** `lab` · Primary lab: `git-reflog` · **Shipped**

[← Cherry-pick](../module12-git-cherry-pick-lab/README.md) · [Course README](../README.md) · [Blame & bisect →](../module14-blame-bisect/README.md)

## Outcomes

After this module you can explain and practice the ideas taught by **`git-reflog`**, in the browser and/or with real Git.
...
1. Local: [http://127.0.0.1:8080/tools/git-reflog/index.html](http://127.0.0.1:8080/tools/git-reflog/index.html)
2. Live: [https://universal-verification-methodology.github.io/learning/tools/git-reflog/](https://universal-verification-methodology.github.io/learning/tools/git-reflog/)
