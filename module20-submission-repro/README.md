...
**Kind:** `lab` · Primary lab: `submission-repro` · **Shipped**

[← Template-repo bootstrap](../module19-template-clone/README.md) · [Course README](../README.md) · [Live sandbox: clone → Make → PR →](../module21-sandbox/README.md)

## Outcomes

After this module you can explain and practice the ideas taught by **`submission-repro`**, in the browser and/or with real Git.
...
1. Local: [http://127.0.0.1:8080/tools/submission-repro/index.html](http://127.0.0.1:8080/tools/submission-repro/index.html)
2. Live: [https://universal-verification-methodology.github.io/learning/tools/submission-repro/](https://universal-verification-methodology.github.io/learning/tools/submission-repro/)
