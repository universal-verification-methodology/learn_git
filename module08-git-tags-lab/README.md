...
**Kind:** `lab` · Primary lab: `git-tags-lab` · **Shipped**

[← Stash scenarios](../module07-git-stash-lab/README.md) · [Course README](../README.md) · [Branch naming →](../module09-branch-strategy/README.md)

## Outcomes

After this module you can explain and practice the ideas taught by **`git-tags-lab`**, in the browser and/or with real Git.
...
1. Local: [http://127.0.0.1:8080/tools/git-tags-lab/index.html](http://127.0.0.1:8080/tools/git-tags-lab/index.html)
2. Live: [https://universal-verification-methodology.github.io/learning/tools/git-tags-lab/](https://universal-verification-methodology.github.io/learning/tools/git-tags-lab/)
