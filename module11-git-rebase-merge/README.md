...
**Kind:** `lab` · Primary lab: `git-rebase-merge` · **Shipped**

[← Merge conflicts](../module10-git-conflicts/README.md) · [Course README](../README.md) · [Cherry-pick →](../module12-git-cherry-pick-lab/README.md)

## Outcomes

After this module you can explain and practice the ideas taught by **`git-rebase-merge`**, in the browser and/or with real Git.
...
1. Local: [http://127.0.0.1:8080/tools/git-rebase-merge/index.html](http://127.0.0.1:8080/tools/git-rebase-merge/index.html)
2. Live: [https://universal-verification-methodology.github.io/learning/tools/git-rebase-merge/](https://universal-verification-methodology.github.io/learning/tools/git-rebase-merge/)
